...
while(1): 
	...
	for pic, contour in enumerate(contours): 
		...
		if(area > 300): 
			...
			cv.putText(imageFrame, "Merah", (x, y), 
	...
	for pic, contour in enumerate(contours): 
		...
		if(area > 300): 
			...
			cv.putText(imageFrame, "Hijau", (x, y), 
	...
	for pic, contour in enumerate(contours): 
		...
		if(area > 300): 
			...
			cv.putText(imageFrame, "Biru", (x, y), 
						cv.FONT_HERSHEY_SIMPLEX, 
						1.0, (255, 0, 0)) 
